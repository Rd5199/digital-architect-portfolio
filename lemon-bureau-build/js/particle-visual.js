...
const PV = {
  config: {
    ...
    maxDisplacement: 500,
    returnForce: 0.05,
    logoPath: `${assetBase}home/particle-visual.png`,
    particleSpacing: 5,
  },
  canvas: null,
  gl: null,
...
// webgl render
function render() {
  if (!PV.gl || !PV.program || !PV.canvas || !PV.geometry) return;
...
function handleResize() {
  ...
  // Resize can fire while the logo image is still loading.
  if (!PV.geometry || !PV.posArray || PV.particles.length === 0) return;
