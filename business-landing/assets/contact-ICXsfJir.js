...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function $a(e,t,n){let r=new Float32Array(za),i=new K(0,1,0);return new Ci({name:`SphericalGaussianBlur`,defines:{n:za,CUBEUV_TEXEL_WIDTH:1/t,CUBEUV_TEXEL_HEIGHT:1/n,CUBEUV_MAX_MIP:`${e}.0`},uniforms:{envMap:{value:null},samples:{value:1},weights:{value:r},latitudinal:{value:!1},dTheta:{value:0},mipInt:{value:0},poleAxis:{value:i}},vertexShader:no(),fragmentShader:`
	...
	`}var ro=class extends Ut{constructor(e=1,t={}){super(e,e,t),this.isWebGLCubeRenderTarget=!0;let n={width:e,height:e,depth:1},r=[n,n,n,n,n,n];this.texture=new si(r),this._setTextureOptions(t),this.texture.isRenderTargetTexture=!0}fromEquirectangularTexture(e,t){this.texture.type=t.type,this.texture.colorSpace=t.colorSpace,this.texture.generateMipmaps=t.generateMipmaps,this.texture.minFilter=t.minFilter,this.texture.magFilter=t.magFilter;let n={uniforms:{tEquirect:{value:null}},vertexShader:`
...
void main() {
	...
	if ( coord.x >= 1.0 ) {
		...
		`};var Gc=class extends Ci{constructor(e){super({type:`LineMaterial`,uniforms:bi.clone(Oa.line.uniforms),vertexShader:Oa.line.vertexShader,fragmentShader:Oa.line.fragmentShader,clipping:!0}),this.isLineMaterial=!0,this.setValues(e)}get color(){return this.uniforms.diffuse.value}set color(e){this.uniforms.diffuse.value=e}get worldUnits(){return`WORLD_UNITS`in this.defines}set worldUnits(e){e===!0!==this.worldUnits&&(this.needsUpdate=!0),e===!0?this.defines.WORLD_UNITS=``:delete this.defines.WORLD_UNITS}get linewidth(){return this.uniforms.linewidth.value}set linewidth(e){this.uniforms.linewidth&&(this.uniforms.linewidth.value=e)}get dashed(){return`USE_DASH`in this.defines}set dashed(e){e===!0!==this.dashed&&(this.needsUpdate=!0),e===!0?this.defines.USE_DASH=``:delete this.defines.USE_DASH}get dashScale(){return this.uniforms.dashScale.value}set dashScale(e){this.uniforms.dashScale.value=e}get dashSize(){return this.uniforms.dashSize.value}set dashSize(e){this.uniforms.dashSize.value=e}get dashOffset(){return this.uniforms.dashOffset.value}set dashOffset(e){this.uniforms.dashOffset.value=e}get gapSize(){return this.uniforms.gapSize.value}set gapSize(e){this.uniforms.gapSize.value=e}get opacity(){return this.uniforms.opacity.value}set opacity(e){this.uniforms&&(this.uniforms.opacity.value=e)}get resolution(){return this.uniforms.resolution.value}set resolution(e){this.uniforms.resolution.value.copy(e)}get alphaToCoverage(){return`USE_ALPHA_TO_COVERAGE`in this.defines}set alphaToCoverage(e){this.defines&&(e===!0!==this.alphaToCoverage&&(this.needsUpdate=!0),e===!0?this.defines.USE_ALPHA_TO_COVERAGE=``:delete this.defines.USE_ALPHA_TO_COVERAGE)}},Kc=new Y,qc=new K,Jc=new K,Yc=new Y,Xc=new Y,Zc=new Y,Qc=new K,$c=new Kt,el=new Ca,tl=new K,nl=new Wn,rl=new hr,il=new Y,al,ol;function sl(e,t,n){return il.set(0,0,-t,1).applyMatrix4(e.projectionMatrix),il.multiplyScalar(1/il.w),il.x=ol/n.width,il.y=ol/n.height,il.applyMatrix4(e.projectionMatrixInverse),il.multiplyScalar(1/il.w),Math.abs(Math.max(il.x,il.y))}function cl(e,t){let n=e.matrixWorld,r=e.geometry,i=r.attributes.instanceStart,a=r.attributes.instanceEnd,o=Math.min(r.instanceCount,i.count);for(let r=0,s=o;r<s;r++){el.start.fromBufferAttribute(i,r),el.end.fromBufferAttribute(a,r),el.applyMatrix4(n);let o=new K,s=new K;al.distanceSqToSegment(el.start,el.end,s,o),s.distanceTo(o)<ol*.5&&t.push({point:s,pointOnLine:o,distance:al.origin.distanceTo(s),object:e,face:null,faceIndex:r,uv:null,uv1:null})}}function ll(e,t,n){let r=t.projectionMatrix,i=e.material.resolution,a=e.matrixWorld,o=e.geometry,s=o.attributes.instanceStart,c=o.attributes.instanceEnd,l=Math.min(o.instanceCount,s.count),u=-t.near;al.at(1,Zc),Zc.w=1,Zc.applyMatrix4(t.matrixWorldInverse),Zc.applyMatrix4(r),Zc.multiplyScalar(1/Zc.w),Zc.x*=i.x/2,Zc.y*=i.y/2,Zc.z=0,Qc.copy(Zc),$c.multiplyMatrices(t.matrixWorldInverse,a);for(let t=0,o=l;t<o;t++){if(Yc.fromBufferAttribute(s,t),Xc.fromBufferAttribute(c,t),Yc.w=1,Xc.w=1,Yc.applyMatrix4($c),Xc.applyMatrix4($c),Yc.z>u&&Xc.z>u)continue;if(Yc.z>u){let e=Yc.z-Xc.z,t=(Yc.z-u)/e;Yc.lerp(Xc,t)}else if(Xc.z>u){let e=Xc.z-Yc.z,t=(Xc.z-u)/e;Xc.lerp(Yc,t)}Yc.applyMatrix4(r),Xc.applyMatrix4(r),Yc.multiplyScalar(1/Yc.w),Xc.multiplyScalar(1/Xc.w),Yc.x*=i.x/2,Yc.y*=i.y/2,Xc.x*=i.x/2,Xc.y*=i.y/2,el.start.copy(Yc),el.start.z=0,el.end.copy(Xc),el.end.z=0;let o=el.closestPointToPointParameter(Qc,!0);el.at(o,tl);let l=wt.lerp(Yc.z,Xc.z,o),d=l>=-1&&l<=1,f=Qc.distanceTo(tl)<ol*.5;if(d&&f){el.start.fromBufferAttribute(s,t),el.end.fromBufferAttribute(c,t),el.start.applyMatrix4(a),el.end.applyMatrix4(a);let r=new K,i=new K;al.distanceSqToSegment(el.start,el.end,i,r),n.push({point:i,pointOnLine:r,distance:al.origin.distanceTo(i),object:e,face:null,faceIndex:t,uv:null,uv1:null})}}}var ul=class extends Yr{constructor(e=new Wc,t=new Gc({color:Math.random()*16777215})){super(e,t),this.isLineSegments2=!0,this.type=`LineSegments2`}computeLineDistances(){let e=this.geometry,t=e.attributes.instanceStart,n=e.attributes.instanceEnd,r=new Float32Array(2*t.count);for(let e=0,i=0,a=t.count;e<a;e++,i+=2)qc.fromBufferAttribute(t,e),Jc.fromBufferAttribute(n,e),r[i]=i===0?0:r[i-1],r[i+1]=r[i]+qc.distanceTo(Jc);let i=new ha(r,2,1);return e.setAttribute(`instanceDistanceStart`,new Er(i,1,0)),e.setAttribute(`instanceDistanceEnd`,new Er(i,1,1)),this}raycast(e,t){let n=this.material.worldUnits,r=e.camera;r===null&&!n&&console.error(`LineSegments2: "Raycaster.camera" needs to be set in order to raycast against LineSegments2 while worldUnits is set to false.`);let i=e.params.Line2===void 0?0:e.params.Line2.threshold||0;al=e.ray;let a=this.matrixWorld,o=this.geometry,s=this.material;ol=s.linewidth+i,o.boundingSphere===null&&o.computeBoundingSphere(),rl.copy(o.boundingSphere).applyMatrix4(a);let c;if(c=n?ol*.5:sl(r,Math.max(r.near,rl.distanceToPoint(al.origin)),s.resolution),rl.radius+=c,al.intersectsSphere(rl)===!1)return;o.boundingBox===null&&o.computeBoundingBox(),nl.copy(o.boundingBox).applyMatrix4(a);let l;l=n?ol*.5:sl(r,Math.max(r.near,nl.distanceToPoint(al.origin)),s.resolution),nl.expandByScalar(l),al.intersectsBox(nl)!==!1&&(n?cl(this,t):ll(this,r,t))}onBeforeRender(e){let t=this.material.uniforms;t&&t.resolution&&(e.getViewport(Kc),this.material.uniforms.resolution.value.set(Kc.z,Kc.w))}},dl=55,fl=.1,pl=.72,ml=.9995,hl=8,gl=2.5,_l=1.85,vl=48e-5,yl=82e-5,bl=22e-5,xl=_l-fl,Sl=fl*2,Cl=Sl*Sl,wl=45,Tl=Math.sqrt(3)*_l,El=Tl/Math.tan(wl/2*Math.PI/180)*1.4,Dl=Math.round(Tl*200+80),Ol=document.getElementById(`cube-canvas`),kl=Ol.parentElement;kl.style.height=`${Dl}px`;var Al=new Vc({canvas:Ol,antialias:!0,alpha:!0});Al.setPixelRatio(Math.min(devicePixelRatio,2)),Al.setClearColor(0,0);var jl=new kn,Ml=new Xi(wl,1,.01,100);Ml.position.set(0,0,El);var Nl=1,Pl=1;function Fl(){Nl=kl.offsetWidth||Dl,Pl=kl.offsetHeight||Dl,Al.setSize(Nl,Pl,!1),Ml.aspect=Nl/Pl,Ml.updateProjectionMatrix(),Hl.resolution.set(Nl,Pl)}var Il=new xn;jl.add(Il);var Ll=_l,Rl=[[-1.85,-1.85,-1.85],[Ll,-1.85,-1.85],[Ll,Ll,-1.85],[-1.85,Ll,-1.85],[-1.85,-1.85,Ll],[Ll,-1.85,Ll],[Ll,Ll,Ll],[-1.85,Ll,Ll]],zl=[[0,1],[1,2],[2,3],[3,0],[4,5],[5,6],[6,7],[7,4],[0,4],[1,5],[2,6],[3,7]],Bl=[];for(let[e,t]of zl)Bl.push(...Rl[e],...Rl[t]);var Vl=new Wc;Vl.setPositions(Bl);var Hl=new Gc({color:986895,linewidth:gl,worldUnits:!1}),Ul=new ul(Vl,Hl);Il.add(Ul);var Wl=new pi(fl,14,10),Gl=new Lr({color:986895}),Kl=[],$=[],ql=[];for(let e=0;e<dl;e++){let e=new K((Math.random()-.5)*_l*1.6,(Math.random()-.5)*_l*1.6,(Math.random()-.5)*_l*1.6);e.clampScalar(-1.75,xl),Kl.push(e),$.push(new K((Math.random()-.5)*_l*1.5,(Math.random()-.5)*_l*1.5,(Math.random()-.5)*_l*1.5));let t=new Yr(Wl,Gl);t.position.copy(e),Il.add(t),ql.push(t)}var Jl=new K,Yl=new K(0,-9.8,0),Xl=new Tt;function Zl(e){let t=e/hl,n=ml**+e;for(let e=0;e<hl;e++){for(let e=0;e<dl;e++)$[e].x+=Jl.x*t,$[e].y+=Jl.y*t,$[e].z+=Jl.z*t,Kl[e].x+=$[e].x*t,Kl[e].y+=$[e].y*t,Kl[e].z+=$[e].z*t;for(let e=0;e<dl;e++){let t=Kl[e],n=$[e];t.x<-1.75&&(t.x=-1.75,n.x<0&&(n.x=-n.x*pl)),t.x>xl&&(t.x=xl,n.x>0&&(n.x=-n.x*pl)),t.y<-1.75&&(t.y=-1.75,n.y<0&&(n.y=-n.y*pl)),t.y>xl&&(t.y=xl,n.y>0&&(n.y=-n.y*pl)),t.z<-1.75&&(t.z=-1.75,n.z<0&&(n.z=-n.z*pl)),t.z>xl&&(t.z=xl,n.z>0&&(n.z=-n.z*pl))}for(let e=0;e<dl-1;e++)for(let t=e+1;t<dl;t++){let n=Kl[t].x-Kl[e].x,r=Kl[t].y-Kl[e].y,i=Kl[t].z-Kl[e].z,a=n*n+r*r+i*i;if(a>=Cl||a<1e-10)continue;let o=Math.sqrt(a),s=n/o,c=r/o,l=i/o,u=(Sl-o)*.5;Kl[e].x-=s*u,Kl[e].y-=c*u,Kl[e].z-=l*u,Kl[t].x+=s*u,Kl[t].y+=c*u,Kl[t].z+=l*u;let d=($[t].x-$[e].x)*s+($[t].y-$[e].y)*c+($[t].z-$[e].z)*l;if(d>=0)continue;let f=d*1.72*.5;$[e].x+=f*s,$[e].y+=f*c,$[e].z+=f*l,$[t].x-=f*s,$[t].y-=f*c,$[t].z-=f*l}}for(let e=0;e<dl;e++)$[e].multiplyScalar(n)}Fl(),window.addEventListener(`resize`,Fl);var Ql=.3,$l=.2,eu=0,tu=0,nu=vl,ru=yl,iu=bl,au=3,ou=!1,su=0,cu=0,lu=0,uu=0,du=.3,fu=.2,pu=.005,mu=.1,hu=.88;function gu(e){return e.touches?[e.touches[0].clientX,e.touches[0].clientY]:[e.clientX,e.clientY]}Ol.addEventListener(`mousedown`,e=>{ou=!0,[su,cu]=gu(e),lu=uu=0,du=Ql,fu=$l,Ol.style.cursor=`grabbing`}),Ol.addEventListener(`touchstart`,e=>{ou=!0,[su,cu]=gu(e),lu=uu=0,du=Ql,fu=$l},{passive:!0}),window.addEventListener(`mousemove`,e=>{if(!ou)return;let[t,n]=gu(e),r=(t-su)*pu,i=(n-cu)*pu;fu+=r,du+=i,lu=r,uu=i,su=t,cu=n}),window.addEventListener(`touchmove`,e=>{if(!ou)return;let[t,n]=gu(e),r=(t-su)*pu,i=(n-cu)*pu;fu+=r,du+=i,lu=r,uu=i,su=t,cu=n},{passive:!0}),window.addEventListener(`mouseup`,()=>{ou=!1,Ol.style.cursor=`grab`}),window.addEventListener(`touchend`,()=>{ou=!1}),Ol.style.cursor=`grab`;function _u(e){let t=Math.min((e-tu)/1e3,.033);if(tu=e,ou)Ql+=(du-Ql)*mu,$l+=(fu-$l)*mu;else{$l+=lu,Ql+=uu,lu*=hu,uu*=hu;let e=Math.abs(lu)+Math.abs(uu),n=Math.max(0,1-e/.01);nu+=(Math.random()-.5)*3e-6,ru+=(Math.random()-.5)*3e-6,iu+=(Math.random()-.5)*3e-6,nu=Math.max(vl*.6,Math.min(vl*1.4,nu)),ru=Math.max(yl*.6,Math.min(yl*1.4,ru)),iu=Math.max(bl*.6,Math.min(bl*1.4,iu)),Ql+=nu*t*1e3*n,$l+=ru*t*1e3*n,eu+=iu*t*1e3*n}if(Il.rotation.set(Ql,$l,eu),Xl.setFromEuler(Il.rotation).invert(),Jl.copy(Yl).applyQuaternion(Xl),au-=t,au<=0){let e=_l*1.5;for(let t=0;t<dl;t++)$[t].x+=(Math.random()-.5)*e,$[t].y+=(Math.random()-.5)*e,$[t].z+=(Math.random()-.5)*e;au=2.5+Math.random()*2}Zl(t);for(let e=0;e<dl;e++)ql[e].position.copy(Kl[e]);Al.render(jl,Ml),requestAnimationFrame(_u)}requestAnimationFrame(e=>{tu=e,requestAnimationFrame(_u)});